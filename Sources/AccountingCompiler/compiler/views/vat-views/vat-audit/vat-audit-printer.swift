...
public extension VATAuditReport {
    func renderText(
        ...
        out.append("Totals")
        out.append("──────")
        out.append("Ledger owed:       \(fmt(displayTotalLedgerOwed))")
        out.append("Ledger receivable: \(fmt(displayTotalLedgerReceivable))")
        ...
        for quarter in rows {
            ...
            out.append("ledger owed:       \(fmt(quarter.displayLedgerOwed))")
            out.append("ledger receivable: \(fmt(quarter.displayLedgerReceivable))")
