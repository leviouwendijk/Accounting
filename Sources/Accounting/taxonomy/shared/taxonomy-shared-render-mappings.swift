...
public func renderResolvedMappings(
    _ mappings: [TaxonomyResolvedMapping],
    limit: Int = 200
) {
...
public func renderComputedMappedFacts(
    _ factsByKey: [TaxonomyMappedFactKey: TaxonomyComputedMappedFact],
    limit: Int = 200
) {
...
public func renderCanonicalMappings(
    mappings: [TaxonomyCanonicalResolvedMapping],
    prefix: String? = nil,
    limit: Int = 200
) {
...
public func renderMappingResolutionDiagnostics(
    _ diagnostics: TaxonomyMappingResolutionDiagnostics,
    indent: String = "  "
) {
